...
const ADMIN_NAV = [
  { label: 'System Status', href: '/admin/dashboard', icon: LayoutDashboard },
  { label: 'Institutions', href: '/admin/universities', icon: School },
    ...
    <div className="min-h-screen bg-black flex text-[#E1E0CC]">
      ...
      <aside className="w-64 border-r border-white/5 bg-[#101010] flex flex-col h-screen sticky top-0">
        ...
        <div className="px-5 py-6 border-b border-white/5">
          ...
          <span className="text-[10px] text-white/30 uppercase tracking-widest font-semibold block mt-1">Super Admin Portal</span>
        </div>
